...
export function Hero({ eyebrow, title, description, heroCard }: HeroProps) {
  return (
    <section className="relative isolate overflow-hidden bg-slate-950 text-white">
      ...
      <div className="mx-auto grid min-h-[560px] max-w-[1200px] items-end gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_340px] lg:px-8 lg:py-16">
