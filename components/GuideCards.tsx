  ...
  return (
    <section className="mx-auto max-w-[1200px] px-4 pb-4 sm:px-6 lg:px-8" aria-labelledby="guide-heading">
      <div className="flex flex-wrap items-end justify-between gap-3 border-b-4 border-slate-950 pb-4">
        <div><p className="border-l-4 border-teal pl-2 text-xs font-black uppercase tracking-[0.18em] text-ink">Pick a direction</p><h2 id="guide-heading" className="mt-1 text-3xl font-black tracking-tight text-ink">Trailhead guides</h2></div>
